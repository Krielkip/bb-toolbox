  ...
  static public function get_seo_plugin($post) {
    if (self::has_seo_plugin(array(
      ...
      if (self::has_seo_plugin(array(
        ...
        if (self::has_seo_plugin(array('classes' => array('HeadSpace_Plugin')))) {
          //  HeadSpace2 SEO
          $meta_title_field = '_headspace_page_title';
          $meta_description_field = '_headspace_description';
        }
        else {
          if (self::has_seo_plugin(array('classes' => array('Platinum_SEO_Pack')))) {
            //  Platinum SEO Pack
            $meta_title_field = 'title';
            $meta_description_field = 'description';
          }
          else {
            if (self::has_seo_plugin(array('functions' => array('genesis_constants'))) || self::has_seo_plugin(array('classes' => array('The_SEO_Framework_Load')))) {
